...
The screenshots below demonstrate the major pages of the application. They are located in the `docs/screenshots/` folder.
...
![All Tickets](docs/screenshots/ticket-list.png)
...
![Delete Confirmation](docs/screenshots/delete-ticket.png)
...
Confirms that the API and database are running correctly.
## Architecture
